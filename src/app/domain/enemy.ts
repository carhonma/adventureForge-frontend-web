...
import {enemyStyles, EnemyType } from "../enum/enemyType";
...
export class Enemy {
  ...
  constructor(id: string, name: string, type: EnemyType, level: number, actualLife: string, actualExp: string, skill1: string, skill2: string, skill3: string, skill4: string, skill5: string, 
    ...
    this.name = name;
    this.type = type;
    this.icon = enemyStyles[type as EnemyType]?.icon || '❓'
    this.level = level;
