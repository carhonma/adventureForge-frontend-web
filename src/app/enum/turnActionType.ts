export enum TurnActionType {
  ...
  export const turnActionStyles: Record<TurnActionType, { icon: string, description: string; }> = {
    [TurnActionType.STANDARD_ATTACK]: { icon: 'skills/STANDARD_ATTACK.png',description: 'El campeón realiza un ataque de:<br>x1 Dbrutal<br>x1 Dletal<br>x1 Dmistic'},
    [TurnActionType.HARD_STRIKE]: { icon: 'skills/HARD_STRIKE.png',description: 'El campeón realiza un ataque de:<br>x1.5 Dbrutal'},
    [TurnActionType.HARD_SHOT]: { icon: 'skills/HARD_SHOT.png',description: 'El campeón realiza un ataque de:<br>x1.5 Dletal'},
    [TurnActionType.HARD_SPELL]: { icon: 'skills/HARD_SPELL.png',description: 'El campeón realiza un ataque de:<br>x1.5 Dmistic'},
