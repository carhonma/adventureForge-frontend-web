export enum EnemyType {
  ...
  export const enemyStyles: Record<EnemyType, { backgroundColor: string; longBackground: string ; icon: string; missionIcon: string; gifVictory: string; gifDefeat: string; description: string; }> = {
    ...
    [EnemyType.JABALI5_UP1]: { backgroundColor: '#7E0602',longBackground: '#966E64', icon: 'characters/A_jabali5_up1.jpg', missionIcon: 'mission/C_jabali5_up1.png', gifVictory: 'gifs/Y_jabali5_victory.gif', gifDefeat: 'gifs/Y_jabali5_defeat.gif', description: 'Descripción de JABALI1_UP1'},
    [EnemyType.JABALI5_UP2]: { backgroundColor: '#7E0602',longBackground: '#966E64', icon: 'characters/A_jabali5_up2.jpg', missionIcon: 'mission/C_jabali5_up2.png', gifVictory: 'gifs/Y_jabali5_victory.gif', gifDefeat: 'gifs/Y_jabali5_defeat.gif', description: 'Descripción de JABALI1_UP2'},
