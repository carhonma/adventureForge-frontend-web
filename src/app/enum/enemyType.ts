export enum EnemyType {
  ...
  export const enemyStyles: Record<EnemyType, { backgroundColor: string; longBackground: string ; icon: string; missionIcon: string; gifVictory: string; gifDefeat: string; description: string; }> = {
    ...
    [EnemyType.ENT1_UP1]: { backgroundColor: '#7E0602',longBackground: '#966E64', icon: 'characters/A_ent1_up1.jpg', missionIcon: 'mission/C_ent1_up1.png', gifVictory: 'gifs/Y_ent1_victory.gif', gifDefeat: 'gifs/Y_ent1_defeat.gif', description: 'Descripción de ENT1_UP1'},
    [EnemyType.ENT1_UP2]: { backgroundColor: '#7E0602',longBackground: '#966E64', icon: 'characters/A_ent1_up2.jpg', missionIcon: 'mission/C_ent1_up2.png', gifVictory: 'gifs/Y_ent1_victory.gif', gifDefeat: 'gifs/Y_ent1_defeat.gif', description: 'Descripción de ENT1_UP2'},
